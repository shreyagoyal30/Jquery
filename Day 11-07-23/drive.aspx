<%@ Page Language="C#" AutoEventWireup="true" CodeFile="drive.aspx.cs" Inherits="settings_BASDrive_external_drive" %>
...
<body>
                    ...
                    <div class="row g-3 mb-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Manage External Drive</li>
                            </ol>
                        </nav>
                    </div>
   ...
   <script src="/assets/js/pageJS/settings/BASDrive/drive.js"></script>
    ...
    <!-- offcanvas-->
    <div class="offcanvas offcanvas-end" id="_editDriveName" tabindex="-1" aria-labelledby="offcanvasRightLabel">
      <div class="offcanvas-header">
        <h5 class="_title">Edit name</h5><button class="btn-close text-reset" type="button" data-bs-dismiss="offcanvas" aria-label="Close"></button>
      </div>
      <div class="offcanvas-body">
          <p>Assigned users will see this name inside BASDrive</p>
          <div class="form-group">
              <label>Size</label>
              <h4 id="_editDriveNme-size"></h4>
          </div>
          <div class="form-group">
              <label>Name</label>
              <input type="text" class="form-control" id="_editDriveName-name" />
          </div>
          <div class="form-group mt-3">
              <a href="javascript:void(0)" class="btn btn-success btn-block w-100" id="_btnEditDriveName-save">Save</a>
          </div>
      </div>
    </div>
</body>
